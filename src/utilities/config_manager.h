 ...
 * @brief Configuration management system for ComChemKit
 * @author Le Nhan Pham
 * @date 2025
 *
 ...
 */
const std::string DEFAULT_CONFIG_FILENAME = ".comchemkit.conf";
 ...
 */
const std::string ALT_CONFIG_FILENAME = "comchemkit.conf";
...
namespace ConfigUtils
{
    ...
    /**
      ...
      * @return Multi-line string showing
     * where configuration files are searched
      *
      * Returns human-readable description of configuration file
     * search
     ...
     * empty string if unable to determine
      *
      * Platform-specific implementation to locate the directory
     * containing
      * the running executable for configuration file search.
      */
